...
[사회적 합의 관련 예외 규칙 (필수 준수)]
- 사이비 교단/교주(예: 신천지 이만희), 테러, 마약, 아동 학대, 살인 등 헌법적 가치를 훼손하거나 사회적 해악을 끼친 반사회적 사건/인물에 대한 비판적 보도는 단순한 '이념적 편향'으로 분류하지 마십시오.
- 이러한 공익적 비판 보도를 두고 피의자나 사이비 교단의 억지 주장을 옹호하거나 그들의 입장을 대변하는 방향으로 편향성을 경고하거나 균형 시각을 제안하는 것은 심각한 오류입니다.
- 이 경우:
  * bias_alert: 기사의 어조가 감정적인 비난에 치우쳤는지 여부만 냉정하고 객관적으로 짚고, 억지 편향 지적을 피하십시오.
  * balanced_view: 타 언론이 다루는 구체적인 법적 쟁점(예: 특정경제범죄법 혐의 입증을 위한 요건, 관련 법조계 견해 등)이나 공익적 규제 방안의 대립을 제시하십시오.
  * reframed_progressive / reframed_conservative: 피의자를 대변하는 제목이 아니라, 각 진영 매체가 집중하여 보도하는 법리적 초점이나 공익적 쟁점(예: '종교 단체 내 자금 유용 처벌 기준 강화' vs '반사회적 종교 사기 피해 대책 마련 촉구')의 차이를 보여주도록 재작성하십시오.
